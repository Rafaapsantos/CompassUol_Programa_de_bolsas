...
from awsglue.job import Job  # Importação do Job adicionada
...
# Filtra os filmes com os IDs fornecidos
filtered_movies_df = movies_df.filter(movies_df["id"].isin(imdb_ids))

# Seleciona somente as colunas desejadas
selected_movies_df = filtered_movies_df.select(*colunas_selecionadas)

# Salva o resultado em formato Parquet no destino especificado
