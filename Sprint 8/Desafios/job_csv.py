...
# Lista de IDs IMDB de filmes que devem ser incluídos
...
# Filtra os dados para incluir apenas os filmes com os IDs da lista
dados_selecionados = filtra_dados.filter(col("id").isin(imdb_ids))

# Remove duplicatas com base no campo 'id'
dados_unicos = dados_selecionados.dropDuplicates(["id"])
...
dados_limpos = dados_unicos.select(*colunas_selecionadas)
