...
# Lista para armazenar os dados dos filmes buscados
filmes = []

# itera sobre os IDs do IMDb
for imdb_id in imdb_ids:
    # URL de requisição da API do TMDB
    url = f"{url}/{imdb_id}?api_key={chave_api}&language=pt-BR"
    ...
    if response.status_code == 200:
        ...
        filmes.append(filme_info)# adiciona os registros na lista
    else:
